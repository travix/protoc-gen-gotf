...
// Ensure *UserResource fully satisfy terraform framework interfaces.
...
func NewUserResource(proxy rsrc.Resource) func() resource.Resource {
	if proxy == nil {
		panic("github.com/travix/gotf/rsrc.Resource is required")
	}
	return func() resource.Resource {
		return &UserResource{proxy: proxy}
	}
}
...
func (r *UserResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
	...
	r.client = pb.NewUserServiceClient(conn)
...
func (r *UserResource) ConfigValidators(ctx context.Context) []resource.ConfigValidator {
	...
	tflog.Warn(ctx, "ConfigValidators method not implemented.Make sure argument to NewUserResource() implements rsrc.CanConfigValidators interface")
	return nil
}
...
func (r *UserResource) ValidateConfig(ctx context.Context, req resource.ValidateConfigRequest, resp *resource.ValidateConfigResponse) {
	...
	tflog.Warn(ctx, "ValidateConfig method not implemented.Make sure argument to NewUserResource() implements rsrc.CanValidateConfig interface")
}
...
func (r *UserResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	...
	tflog.Warn(ctx, "ImportState method not implemented.Make sure argument to NewUserResource() implements rsrc.CanImportState interface")
}
...
func (r *UserResource) ModifyPlan(ctx context.Context, req resource.ModifyPlanRequest, resp *resource.ModifyPlanResponse) {
	...
	tflog.Warn(ctx, "ModifyPlan method not implemented.Make sure argument to NewUserResource() implements rsrc.CanModifyPlan interface")
}
...
func (r *UserResource) UpgradeState(ctx context.Context) map[int64]resource.StateUpgrader {
	...
	tflog.Warn(ctx, "UpgradeState method not implemented.Make sure argument to NewUserResource() implements rsrc.CanUpgradeState interface")
	return nil
}
...
func (r *UserResource) setupContext(ctx context.Context) context.Context {
