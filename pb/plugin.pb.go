...
const (
	NestedType_SingleNestedAttribute NestedType = 0 // field is a single nested objects (message).
	NestedType_ListNestedAttribute   NestedType = 1 // field is a list of nested objects (message).
	NestedType_MapNestedAttribute    NestedType = 2 // field is a map of nested objects (message).
	NestedType_SetNestedAttribute    NestedType = 3 // field is a set of nested objects (message).
)

// Enum value maps for NestedType.
var (
	NestedType_name = map[int32]string{
		0: "SingleNestedAttribute",
		1: "ListNestedAttribute",
		2: "MapNestedAttribute",
		3: "SetNestedAttribute",
	}
	NestedType_value = map[string]int32{
		"SingleNestedAttribute": 0,
		"ListNestedAttribute":   1,
		"MapNestedAttribute":    2,
		"SetNestedAttribute":    3,
	}
)
...
func (x *Attribute) GetNestedType() NestedType {
	...
	return NestedType_SingleNestedAttribute
}
...
var file_plugin_proto_rawDesc = []byte{
	...
	0x0a, 0x0a, 0x4e, 0x65, 0x73, 0x74, 0x65, 0x64, 0x54, 0x79, 0x70, 0x65, 0x12, 0x19, 0x0a, 0x15,
	0x53, 0x69, 0x6e, 0x67, 0x6c, 0x65, 0x4e, 0x65, 0x73, 0x74, 0x65, 0x64, 0x41, 0x74, 0x74, 0x72,
	0x69, 0x62, 0x75, 0x74, 0x65, 0x10, 0x00, 0x12, 0x17, 0x0a, 0x13, 0x4c, 0x69, 0x73, 0x74, 0x4e,
	0x65, 0x73, 0x74, 0x65, 0x64, 0x41, 0x74, 0x74, 0x72, 0x69, 0x62, 0x75, 0x74, 0x65, 0x10, 0x01,
	0x12, 0x16, 0x0a, 0x12, 0x4d, 0x61, 0x70, 0x4e, 0x65, 0x73, 0x74, 0x65, 0x64, 0x41, 0x74, 0x74,
	0x72, 0x69, 0x62, 0x75, 0x74, 0x65, 0x10, 0x02, 0x12, 0x16, 0x0a, 0x12, 0x53, 0x65, 0x74, 0x4e,
